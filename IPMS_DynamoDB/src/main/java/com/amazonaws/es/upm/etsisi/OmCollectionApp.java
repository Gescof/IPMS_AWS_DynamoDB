...
public class OmCollectionApp {
	 ...
	 * @throws JsonParseException 
	 */
	private static void buscarTrazaStr() throws JsonParseException, JsonMappingException, IOException {
		System.out.println("Introduzca el id a buscar: ");
		String id = scanner.nextLine();
		String omTraza = gestorOmCollections.getOmCollectionStr(id, dynamoDBClient);
		if(omTraza != null) {
			System.out.println("Traza encontrada:");
			System.out.println(omTraza);
		} else {
	 ...
	 * @throws JsonParseException 
	 */
	private static void listarTrazas() throws JsonParseException, JsonMappingException, IOException {
	 ...
	 * @throws JsonParseException 
	 */
	private static void listarTrazasStr() throws JsonParseException, JsonMappingException, IOException {
		List<String> listaOmCollections = gestorOmCollections.getListaOmCollectionsStr(dynamoDBClient);
		if(!listaOmCollections.isEmpty()) {
			listaOmCollections.forEach(omColl->System.out.println(omColl));
		} else {
			System.out.println("Lista de trazas vacia.");
